...
export const API_PAGE_PARAGRAPH =
  "Your secret Axie Studio API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const INSERT_API_KEY = "Insert your Axie Studio API key.";
...
export const AXIE_STUDIO_ACCESS_TOKEN = "access_token_as";
export const AXIE_STUDIO_API_TOKEN = "apikey_tkn_as";
export const AXIE_STUDIO_AUTO_LOGIN_OPTION = "auto_login_as";
export const AXIE_STUDIO_REFRESH_TOKEN = "refresh_token_as";
